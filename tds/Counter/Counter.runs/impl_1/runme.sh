...
HD_PWD='/home/mousset/Documents/4A/Projet_Syst_Info/Counter/Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter8bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter8bits.tcl -notrace
