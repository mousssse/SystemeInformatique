...
HD_PWD='/home/mousset/Documents/4A/Projet_Syst_Info/Counter/Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter8bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter8bits.tcl
